...
void TerrainNode::LoadHeightMap()
{
}
...
void TerrainNode::GenerateVertsAndIndices()
{
	...
	for (size_t z = 0; z < GRID_SIZE; z++)
	{
		for (size_t x = 0; x < GRID_SIZE; x++)
		{
			...
			//Set Position
			v1.Position = XMFLOAT3(tlx,		0, tlz);			//Top Left vertex			o--------o
			v2.Position = XMFLOAT3(tlx + 1, 0, tlz);			//Top Right Vertex			|		 |
			v3.Position = XMFLOAT3(tlx,		0, tlz - 1);		//Bottom Left Vertex		|		 |
			v4.Position = XMFLOAT3(tlx + 1, 0, tlz - 1);		//Bottom Right Vertex		o--------o
